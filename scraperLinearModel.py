...
def getFicCharacteristics(thisPage):
    ...
    for w in worksOnPage:
        ...
        try:
            ...
            shipString = ""
            for s in ships:
                this = s.find("a").string
                shipString = shipString + this + ", " #comma'd list of relationships
        ...
        try:
            ...
            charString = ""
            for c in chars:
                this = c.find("a").string
                charString = charString + this + ", " #comma'd list of chars
        ...
        try:
            ...
            freeString = ""
            for f in frees:
                this = f.find("a").string
                freeString = freeString + this + ", " #comma'd list of freeform tags
            freeforms.append(freeString)
        except:
            freeforms.append(".")
            
        #the statistics
        words.append(w.find("dd", {"class": "words"}).string)
        try:
